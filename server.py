...
MUSIC_FOLDER = "songs"  # Diretório das músicas
...
if __name__ == "__main__":
    port = int(os.getenv('PORT', 5000))  # captura a porta fornecida pelo Heroku, padrão para 5000 localmente
    app.run(host='0.0.0.0', port=port, debug=False)  # debug=False para uso em produção
